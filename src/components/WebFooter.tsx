  ...
  return (
    <Cell
      ...
      <RowOrCell justify="flex-start">
        ...
        <Cell left={leftMargin} right={Spacing.medium} vertical={Spacing.large} align="center">
          <Image source={getAsset("svpaLogo")} style={{ width: imageSize, height: imageSize }} />
        </Cell>
      </RowOrCell>
      <Separator />
        ...
        <Cell>
          <Row top={Spacing.large}>
            <Text textStyle={[{ lineHeight: Spacing.midLarge }]} color={Colors.darkerGrey}>
              <LocaleChange />
              {separator}
              <SimpleLinkButton text={t("navigation.aboutScreen")} onPress={openSvpaWebsite} />
              {separator}
              <SimpleLinkButton
              ...
              />
              {separator}
              <SimpleLinkButton text={Config.SVPA_PHONE} onPress={makeAPhoneCall} />
              {separator}
              <SimpleLinkButton text={Config.SVPA_EMAIL} onPress={sendAnEmail} />
              {separator}
          ...
          <RowOrCell flex align="flex-end">
            <Cell
              ...
              <a href="https://apps.apple.com/app/6448645748" target="_blank">
                <Image source={getAsset("app_store_badge")} style={{ height: 60, width: 178 }} />
              </a>
            </Cell>
            <Cell top={isMobile ? Spacing.tiny : 0} left={isMobile ? 0 : Spacing.medium}>
              <a
                href="https://play.google.com/store/apps/details?id=com.floodzilla.floodzuki"
                target="_blank">
                <Image source={getAsset("google_play_badge")} style={{ height: 80, width: 190 }} />
              </a>
            </Cell>
          </RowOrCell>
        </Cell>
